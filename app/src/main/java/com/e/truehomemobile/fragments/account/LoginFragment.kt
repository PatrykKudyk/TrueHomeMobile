    ...
    private fun handleLoginButton() {
        if (areFieldsFilled()) {
            ...
            if (rootView.login_field.text.toString() == "papryk" && rootView.password_field.text.toString() == "Papryk12") {
                ...
                MyApp.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ENJNBNakysmEtGsDkpucKLA1471s-gz2_fctQB1jxK4"
                clearFields()
